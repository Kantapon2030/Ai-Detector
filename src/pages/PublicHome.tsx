  ...
  const performAnalysis = async () => {
    ...
    try {
      ...
      const systemInstruction = `
              ...
              **กฎสำคัญสำหรับการเรียนรู้ (Learning Loop)**:
              1. ข้อมูลอ้างอิง (Admin Learning Context) ที่แอดมินยืนยันว่าเป็น 'ปกติ (มนุษย์)' (not_cheating) มีความสำคัญสูงสุด
              2. หากเนื้อหาที่ส่งมาคล้ายคลึงกับ Pattern เหล่านี้ ให้ปรับคะแนน AI ลงทันทีและยึดถือคำตัดสินของแอดมินเป็นหลัก
              3. หากคุณปรับลดคะแนนลงเพราะข้อมูลของแอดมิน ให้ระบุในส่วน reasoning ด้วยว่า "ปรับปรุงผลลัพธ์โดยอ้างอิงจากข้อมูลการเรียนรู้ล่าสุดของแอดมิน"
